...
export const translations: Record<Locale, TranslationDict> = {
  ...
  fr: {
    ...
    footerQuickLinks: "Liens Ráprimes",
  ...
  de: {
    ...
    aboutDesc2: "Ausgestattet mit mehreren automatisierten Montagelinien, hochpräzisen Kautschuk-Schneidemaschinen und modernsten Laboratory-Prüfgeräten übersteigt unsere Jahresproduktion 12 Millionen Einheiten.",
    aboutStat1Title: "15+",
