...
export const translations: Record<Locale, TranslationDict> = {
  ...
  es: {
    ...
    contactSuccessMsg: "¡Gracias! Su consulta ha sido enviada con éxito. Nuestro equipo de ventas de exportación se pondrá en contacto con usted con precios y catálogo en un prazo de 12 horas.",
    contactErrorMsg: "Error: ",
