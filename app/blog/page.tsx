...
export default function BlogPage() {
  ...
  return (
    <main style={{ fontFamily: "system-ui, -apple-system, sans-serif", color: "#1e293b", backgroundColor: "#fcfcfc" }}>
      ...
      {/* Banner */}
      <section style={{padding: "80px 20px", color: "white", textAlign: "center", borderBottom: "1px solid #1e293b", background: "linear-gradient(rgba(15,23,42,0.8), rgba(15,23,42,0.8)), url('https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=1920&q=80') center/cover no-repeat" }}>
      ...
      {/* Tag Filter */}
      <section style={{ padding: "40px 20px 0", maxWidth: "1250px", margin: "0 auto" }}>
        <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", marginBottom: "40px" }}>
          {allTags.slice(0, 10).map(tag => (
            <button key={tag} onClick={() => setActiveTag(tag)} style={{
              padding: "8px 18px", borderRadius: "20px", cursor: "pointer", fontSize: "13px", fontWeight: 500,
              border: activeTag === tag ? "none" : "1px solid #e2e8f0",
              backgroundColor: activeTag === tag ? "#0284c7" : "#ffffff",
      ...
      {/* Footer */}
      <footer style={{ backgroundColor: "#0f172a", color: "#94a3b8", padding: "60px 20px 40px", textAlign: "center" }}>
