...
export default function BlogPage() {
  ...
  return (
    <main style={{ fontFamily: "system-ui, -apple-system, sans-serif", color: "#1e293b", backgroundColor: "#fcfcfc" }}>
      ...
      {/* Banner */}
      <section style={{padding: "80px 20px", color: "white", textAlign: "center", borderBottom: "1px solid #1e293b", background: "linear-gradient(rgba(15,23,42,0.8), rgba(15,23,42,0.8)), url('https://sc02.alicdn.com/kf/H3fc79edf0c004afebbb2c992eb4cc6edX.png') center/cover no-repeat" }}>
