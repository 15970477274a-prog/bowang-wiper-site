...
export default function AboutPage() {
  ...
  const a: Record<string, Record<string, string>> = {
    en: {
      ...
      milestone3: "Obtained CE certification for the European market.",
    ...
    es: {
      ...
      milestone3: "Obtención de la certificación CE para el mercado europeo.",
    ...
    ru: {
      ...
      milestone3: "Получение сертификации CE для европейского рынка.",
    ...
    fr: {
      ...
      milestone3: "Obtention de la certification CE pour le marché européen.",
    ...
    de: {
      ...
      milestone3: "Erhalt der CE-Zertifizierung für den europäischen Markt.",
