...
export default function ProductsPage() {
  ...
  return (
    <main style={{ fontFamily: "system-ui, -apple-system, sans-serif", color: "#1e293b", backgroundColor: "#fcfcfc" }}>
      ...
      {/* REPLACED WITH MODERN AUTOPARTS WAREHOUSE / SUPPLY CHAIN BANNER */}
      <section style={{ 
        backgroundColor: "#0f172a", 
        padding: "100px 20px", 
        color: "white", 
        textAlign: "center", 
        background: "linear-gradient(rgba(15, 23, 42, 0.8), rgba(15, 23, 42, 0.8)), url('https://images.unsplash.com/photo-1580273916550-e323be2ae537?auto=format&fit=crop&q=80&w=1600') center/cover no-repeat",
        borderBottom: "1px solid #1e293b" 
      }}>
        <h1 style={{ fontSize: "42px", fontWeight: 800, marginBottom: "15px" }}>Wholesale Wiper Blade Solutions</h1>
                    ...
                    <ul style={{ padding: 0, margin: "0 0 25px 0", listStyle: "none" }}>
                      {p.specs.slice(0, 3).map((s, i) => (
                        <li key={i} style={{ fontSize: "13.5px", color: "#475569", marginBottom: "8px", display: "flex", alignItems: "center" }}>
                          <span style={{ color: "#10b981", marginRight: "10px" }}>鉁?/span> {s}
                        </li>
                      ))}
                    </ul>
