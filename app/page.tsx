...
{/* REPLACED WITH PROFESSIONAL RAIN-DRIVING BANNER */}
      <section id="hero" style={{ 
        padding: "140px 20px", 
        textAlign: "center", 
        background: "linear-gradient(rgba(15, 23, 42, 0.7), rgba(15, 23, 42, 0.7)), url('/banner.png') center/cover no-repeat", 
        color: "white" 
      }}>
            ...
            {[
              ...
              >
                <div style={{ padding: "20px 20px 0", textAlign: "center" }}>
                  ...
                  <img src={item.img} alt={item.name} style={{ width: "100%", height: "180px", objectFit: "contain" }} />
                </div>
