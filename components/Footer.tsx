  ...
  return (
    <footer style={{ background: "linear-gradient(135deg, #093D6A 0%, #0a1628 100%)", color: "#cbd5e1", fontSize: "14px", position: "relative" }}>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "14px" }}>
            <li style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
              <div style={{ width: "20px", height: "20px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "2px" }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#38bdf8" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
              </div>
              <div>
                <span style={{ color: "#64748b", fontSize: "11px", textTransform: "uppercase", display: "block", marginBottom: "2px" }}>Cell:</span>
                <a href="tel:+8618867886795" style={{ color: "#e2e8f0", textDecoration: "none", fontSize: "14px" }}>+86 188 6788 6795</a>
              </div>
            </li>
            <li style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
              <div style={{ width: "20px", height: "20px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "2px" }}>
              ...
              <div>
                <span style={{ color: "#64748b", fontSize: "11px", textTransform: "uppercase", display: "block", marginBottom: "2px" }}>Phone:</span>
                <a href="tel:+8657486153346" style={{ color: "#e2e8f0", textDecoration: "none", fontSize: "14px" }}>+86-574-86153346</a>
              </div>
            </li>
            <li style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
              <div style={{ width: "20px", height: "20px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "2px" }}>
              ...
              <div>
                ...
                <a href="mailto:15970477274a@gmail.com" style={{ color: "#e2e8f0", textDecoration: "none", fontSize: "14px" }}>15970477274a@gmail.com</a>
              </div>
            </li>
            <li style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
              <div style={{ width: "20px", height: "20px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "2px" }}>
              ...
              <div>
                <span style={{ color: "#64748b", fontSize: "11px", textTransform: "uppercase", display: "block", marginBottom: "2px" }}>Whatsapp:</span>
      ...
      <div style={{
        ...
        <a href="https://www.facebook.com/" target="_blank" rel="nofollow" style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "40px", height: "40px", borderRadius: "8px", backgroundColor: "rgba(255,255,255,0.1)", transition: "all 0.3s" }} aria-label="Facebook">
        ...
        <a href="https://www.instagram.com/" target="_blank" rel="nofollow" style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "40px", height: "40px", borderRadius: "8px", backgroundColor: "rgba(255,255,255,0.1)", transition: "all 0.3s" }} aria-label="Instagram">
        ...
        <a href="https://www.linkedin.com/" target="_blank" rel="nofollow" style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "40px", height: "40px", borderRadius: "8px", backgroundColor: "rgba(255,255,255,0.1)", transition: "all 0.3s" }} aria-label="LinkedIn">
        ...
        <a href="https://www.youtube.com/" target="_blank" rel="nofollow" style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "40px", height: "40px", borderRadius: "8px", backgroundColor: "rgba(255,255,255,0.1)", transition: "all 0.3s" }} aria-label="YouTube">
